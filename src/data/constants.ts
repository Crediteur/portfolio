...
const PROJ_PATH = "/public/projects/";
...
export const projects = [
  {
    ...
    image: PROJ_PATH + "ai_summarizer.png",
  },
  {
    name: "Doted",
...
export const skills = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "SQL", icon: ICON_PATH + "sqlite.svg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Pandas", icon: ICON_PATH + "pandas.svg" },
      { name: "Jupyter", icon: ICON_PATH + "jupyter.svg" },
    ],
  },
];
